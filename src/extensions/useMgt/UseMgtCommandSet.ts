 ...
 */
export interface IUseMgtCommandSetProperties {
  // This is an example; replace with your own properties
  sampleTextOne: string;
  sampleTextTwo: string;
}

const LOG_SOURCE: string = 'UseMgtCommandSet';

export default class UseMgtCommandSet extends BaseListViewCommandSet<IUseMgtCommandSetProperties> {
